...
/* harmony import */ var _modules_spinner__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/spinner */ "./src/js/modules/spinner.js");
/* harmony import */ var _modules_autoScroll__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/autoScroll */ "./src/js/modules/autoScroll.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  var getAllGoods = function getAllGoods(url) {
    return fetch(url).then(function (res) {
      return res.json();
    });
  };

  getAllGoods(requestUrl).then(function (data) {
    //Формиреуем карточки товара
    Object(_modules_cards__WEBPACK_IMPORTED_MODULE_2__["default"])(data); //Скрываем спиннер

    Object(_modules_spinner__WEBPACK_IMPORTED_MODULE_3__["default"])(".preloader"); //Плавная прокрутка

    Object(_modules_autoScroll__WEBPACK_IMPORTED_MODULE_4__["default"])();
  })["catch"](function (err) {
    Object(_modules_spinner__WEBPACK_IMPORTED_MODULE_3__["default"])(".preloader");
...
/* harmony import */ var _toast__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./toast */ "./src/js/modules/toast.js");
...
var quantity = 0,
    ...
    cartCheckoutBtn = document.querySelector(".shopping-list__buy"); //EVENT LISTENERS
...
var toggleCart = function toggleCart() {
  ...
  cartModalOverlay.classList.toggle("closed"); //IF MODAL OPENING
...
var updateGoodsQuantity = function updateGoodsQuantity() {
  var quantity = Object.keys(CART).length;
...
var updateCart = function updateCart() {
  //CLEAR CART
  var totalCost = 0;
  var row = document.querySelector(".shopping-list__row");
  row.innerHTML = ""; //FILL CART
  ...
  var _loop = function _loop() {
    ...
    elem.innerHTML = "\n    <div class=\"shopping-list__name\"><span>".concat(value.name, "</span></div>\n    <div class=\"shopping-list__price\"><span>").concat(value.price, "</div>\n    <div class=\"shopping-list__quantity\">\n    <span>\n      <div class=\"plus\">&#10009;</div>\n      ").concat(value.quantity, "\n      <div class=\"minus\">&#9866;</div>\n    </span>\n    </div>\n    <div class=\"shopping-list__cost\"><span>\n    ").concat((value.price * value.quantity).toFixed(2), "</span></div>\n    ");
    elem.querySelector(".plus").addEventListener("click", function () {
      incItemCount(key);
    });
    elem.querySelector(".minus").addEventListener("click", function () {
      decItemCount(key);
    });
